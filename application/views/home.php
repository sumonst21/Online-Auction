  ...
  <div class="container">
    <div class="row">
      ...
      <div class="col-md-5 col-sm-6 hero">
        <div class="hero-content">
          <p style="text-align: center;"><b>Login to your account</b></p>

         <?php echo form_open($this->uri->uri_string()); ?>
          <div class="col-lg-12">
            <label>Username</label>
            <input type="text" name="username" required="required" placeholder="Username" autocomplete="disabled" class="col-lg-12">
          </div>
          <br>
          <div class="col-lg-12">
            <label>Password</label>
            <input type="password" name="password" required="required" placeholder="Password" autocomplete="disabled" class="col-lg-12">
          </div>
          <div class="col-lg-9">
            <input type="submit" value="submit" class="col-lg-12 btn btn-primary">
          </div>
          </form>
